...
test_that("split_pref_suff works properly", {
  ...
  expect_equal(split_pref_suff("b [a]", notation = paren_notation()), list(pref = "b", suff = "a"))
  ...
  expect_equal(split_pref_suff("a [ [b]]", notation = paren_notation()), list(pref = "a", suff = " [b]"))
...
test_that("join_pref_suff works properly", {
  ...
  expect_equal(join_pref_suff(ps, notation = paren_notation()) %>% 
                 split_pref_suff(notation = paren_notation()), ps)
...
test_that("flip_pref_suff works as expected", {
  ...
  expect_equal(flip_pref_suff("a [b]", notation = paren_notation()), "b [a]")
  
  # Make sure it works for lists
  expect_equal(flip_pref_suff(list("a -> b", "a -> b"), notation = arrow_notation()), 
               list("b -> a", "b -> a"))
  expect_equal(flip_pref_suff(list("a [b]", "a [b]"), notation = paren_notation()), 
               list("b [a]", "b [a]"))
  ...
  expect_equal(flip_pref_suff("a [b [c]]", notation = paren_notation()), "b [c] [a]")  
})
...
test_that("switch_row_col_notation works as expected", {
  ...
  # Now try "real" cases
  expect_equal(switch_notation("a -> b", from = arrow_notation(), to = paren_notation()), 
               "a [b]")
  expect_equal(switch_notation("a -> b", from = arrow_notation(), to = paren_notation(), flip = TRUE), 
               "b [a]")
  expect_equal(switch_notation("a [b]", from = paren_notation(), to = arrow_notation()), 
               "a -> b")
  expect_equal(switch_notation("a [b]", from = paren_notation(), to = arrow_notation(), flip = TRUE), 
               "b -> a")

  # Try with a list
  expect_equal(switch_notation(list("a -> b", "c -> d"), from = arrow_notation(), to = paren_notation()), 
               list("a [b]", "c [d]"))
  expect_equal(switch_notation(list("a -> b", "c -> d"), from = arrow_notation(), to = paren_notation(), flip = TRUE), 
               list("b [a]", "d [c]"))
  expect_equal(switch_notation(list("a [b]", "c [d]"), from = paren_notation(), to = arrow_notation()), 
               list("a -> b", "c -> d"))
})
...
test_that("switch_notation_byname works as expected", {
  ...
  expect_equal(switch_notation_byname(m, margin = 1, from = paren_notation(), to = arrow_notation()), e)
  ...
  expect_equal(switch_notation_byname(m2, margin = 2, from = paren_notation(), to = arrow_notation()), e2)
  ...
  expect_equal(switch_notation_byname(m3, from = paren_notation(), to = arrow_notation(), flip = TRUE), e3)
