...
The challenges shown above can be solved
...
thereby allowing <tt>byname</tt> to ensure correctness of matrix operations.
...
in which cells contain entire matrices.
...
* the <tt>tidyr</tt> and <tt>dplyr</tt> packages are designed to work with data frames,

<tt>byname</tt> functions can be used with 
<tt>tidyr</tt> and <tt>dplyr</tt> functions 
(such as
...
to allow use of <tt>byname</tt> functions with <tt>tidyr</tt> and <tt>dplyr</tt> 
