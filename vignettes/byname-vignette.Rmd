---
title: "Use Cases and Examples for <tt>matsbyname</tt>"
...
The <tt>byname</tt> package automatically addresses all three problems above.
...
<tt>byname</tt> functions ensure correctness
...
Analysts are encouraged to use <tt>byname</tt> 
...
### <tt>byname</tt> functions work well with lists
...
## Using <tt>byname</tt> with <tt>matsindf</tt>
...
## Suggested workflow using <tt>byname</tt> and <tt>matsindf</tt>
