...
#' @param notation a notation list generated by one of the `*_notation()` functions, such as
#'                      `notation_vec()`, `arrow_notation()`, or `paren_notation()`. 
...
#' @export
#' @rdname row-col-notation
join_pref_suff <- function(ps, notation = arrow_notation()) {
