...
#' @param pref a string or list of strings that are prefixes.
#' @param suff a string of list of strings that are suffixes.
...
#' @export
#' @rdname row-col-notation
join_pref_suff <- function(pref, suff, ps = list(pref = pref, suff = suff), notation = arrow_notation()) {
